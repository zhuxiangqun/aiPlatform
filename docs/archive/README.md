...
| 文件 | 原因 |
|------|------|
| `aiPlat_arch_vs_hermes.md` | 合并入 `docs/architecture/comparison.md` |
| `架构对照-aiPlat-vs-Hermes-vs-ClaudeCode-vs-OpenClaw.md` | 同上 |
| `aiPlat-vs-hermes-vs-claude-code-vs-openclaw-architecture.md` | 同上 |
...
| `aiPlat-17dim-comparison-v3.md` | 被 v4 替代 + 内容已整合入 comparison.md |
| `aiPlat-22dim-comparison-v4.md` | 内容已整合入 comparison.md |
