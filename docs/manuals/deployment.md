...
| 层级 | 特殊要求 | 文档 |
|------|----------|------|
| **infra** | 数据库迁移、数据备份 | [infra 部署指南](../../aiPlat-infra/docs/guides/DEPLOYMENT.md) |
| **core** | 模型预加载、Agent 初始化 | [core 部署指南](../../aiPlat-core/docs/guides/DEPLOYMENT.md) |
| **platform** | API 网关、认证配置 | [platform 部署指南](../../aiPlat-platform/docs/guides/DEPLOYMENT.md) |
| **app** | 前端构建、静态资源 | [app 部署指南](../../aiPlat-app/docs/guides/DEPLOYMENT.md) |
