    ...
    <div className="space-y-6">
      ...
      <details className="bg-dark-card border border-dark-border rounded-lg px-3 py-2 text-xs text-gray-500 cursor-pointer group mb-3">
        ...
        <div className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-1.5">
          <div><span className="text-gray-300">渠道名称</span><span className="ml-2 text-gray-600">渠道的显示名称</span></div>
          <div><span className="text-gray-300">类型</span><span className="ml-2 text-gray-600">Telegram / Slack / WebChat / API / 微信</span></div>
          <div><span className="text-gray-300">状态</span><span className="ml-2 text-gray-600">已连接 / 未连接 / 异常</span></div>
          <div><span className="text-gray-300">消息数</span><span className="ml-2 text-gray-600">通过该渠道收发的消息总数</span></div>
          <div><span className="text-gray-300">最近消息</span><span className="ml-2 text-gray-600">最后一条消息的时间</span></div>
          <div><span className="text-gray-300">操作</span><span className="ml-2 text-gray-600">测试连接 / 删除渠道</span></div>
        </div>
      </details>
