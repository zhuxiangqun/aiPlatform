...
class TestCaseGenerator:
    ...
    async def _explore_page(self, norm: str, depth: int, content_fp: Set[str],
        ...
        for el in elements:
            ...
            try:
                ...
                logging.getLogger(__name__).debug('_explore_page failed', exc_info=True)
        ...
        try:
            ...
            for cd in cards_data:
                ...
                try:
                    ...
                    logging.getLogger(__name__).debug('_record_and_explore_cards failed', exc_info=True)
        except Exception:
    ...
    async def _discover_search(self, norm: str, elements: List[Dict[str, Any]],
        ...
        try:
            ...
            logging.getLogger(__name__).debug('_discover_search failed', exc_info=True)
