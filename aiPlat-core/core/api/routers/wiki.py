...
# ── Proposal Workflow (P2: branch/merge semantics) ──────────────────────────
...
# ── SQL Ontology Bridge (P3: three-layer architecture) ─────────────────────

@router.get("/ontology/sql/mappings", response_model=Dict[str, Any])
...
@router.post("/ontology/sql/query", response_model=Dict[str, Any])
...
@router.get("/ontology/sql/preview", response_model=Dict[str, Any])
