...
@router.post("/browser/test/start")
...
@router.get("/browser/test/status")
...
@router.get("/browser/test/report")
...
@router.post("/browser/test/generate-cases")
...
@router.post("/browser/test/upload-cases")
...
@router.get("/browser/test/download")
...
@router.post("/browser/test/execute-cases")
...
@router.post("/browser/test/execute-cases/stop")
...
@router.get("/browser/test/execute-cases/status")
