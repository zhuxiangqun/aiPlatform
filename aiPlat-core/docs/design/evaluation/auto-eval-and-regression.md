...
- `GET /scopes/{scope_id}/evaluation/policy/latest`（scope 级策略，compat 路由）
- `POST /scopes/{scope_id}/evaluation/policy`（scope 级策略写入，compat 路由）
...
| `GET /api/core/runs/{run_id}/evaluation/latest` | ❌ missing | - |
| `GET /api/core/runs/{run_id}/evidence_pack/latest` | ❌ missing | - |
| `GET /api/core/runs/{run_id}/investigate/latest` | ❌ missing | - |
| `GET /api/core/scopes/{scope_id}/evaluation/policy/latest` | - | - |
| `POST /api/core/evaluation/policy` | - | - |
| `POST /api/core/runs/{run_id}/evaluate/auto` | ❌ missing | - |
| `POST /api/core/runs/{run_id}/evidence/diff` | ❌ missing | - |
| `POST /api/core/runs/{run_id}/investigate/auto` | ❌ missing | - |
