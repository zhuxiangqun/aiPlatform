...
from core.api.core_facade import create_conversation_service

router = APIRouter(prefix="/platform/conversations", tags=["conversations"])
...
async def update_conversation_scope(session_id: str, request: ConversationScopeUpdateRequest, http_request: Request, rt: RuntimeDep = None):
    ...
    from core.services.conversations import normalize_scope
