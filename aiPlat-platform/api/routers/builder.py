...
from api.schemas_response import ProjectListResponse, ProjectStateResponse, PipelineStartResponse, TeamListResponse
...
@router.post("/sessions/{session_id}/approve-architecture", response_model=Dict[str, Any])
...
@router.post("/sessions/{session_id}/reject-architecture", response_model=Dict[str, Any])
...
@router.post("/sessions/{session_id}/approve-test-plan", response_model=Dict[str, Any])
async def session_approve_test_plan(session_id: str, _auth: str = Depends(require_builder_access)):
    return _legacy_response(await _get_svc().approve_stage(session_id))

@router.post("/sessions/{session_id}/reject-test-plan", response_model=Dict[str, Any])
...
@router.post("/projects/{project_id}/chat", response_model=Dict[str, Any])
...
@router.post("/projects/{project_id}/confirm", response_model=Dict[str, Any])
...
@router.post("/projects/{project_id}/recommend-team", response_model=Dict[str, Any])
...
@router.post("/projects/{project_id}/rollback/{stage_id:path}", response_model=Dict[str, Any])
...
@router.post("/projects/{project_id}/rollback-prd", response_model=Dict[str, Any])
...
@router.post("/projects/{project_id}/fix", response_model=Dict[str, Any])
async def project_fix(project_id: str, _auth: str = Depends(require_builder_access)):
    return await _get_svc().start_fix(project_id)

@router.post("/projects/{project_id}/resume/{stage_id:path}", response_model=Dict[str, Any])
...
@router.get("/projects/{project_id}/deploy", response_model=Dict[str, Any])
...
@router.post("/teams/{team_id}/run", response_model=Dict[str, Any])
...
@router.post("/projects/{project_id}/test", response_model=Dict[str, Any])
...
@router.post("/projects/{project_id}/regenerate", response_model=Dict[str, Any])
...
@router.post("/projects/{project_id}/deploy-to-app", response_model=Dict[str, Any])
...
@router.get("/agent-insight/{agent_id}", response_model=Dict[str, Any])
...
@router.get("/agent-insights", response_model=Dict[str, Any])
...
@router.post("/agent-insights/refresh", response_model=Dict[str, Any])
...
@router.get("/projects/{project_id}/health-report", response_model=Dict[str, Any])
...
@router.post("/projects/{project_id}/sign", response_model=Dict[str, Any])
