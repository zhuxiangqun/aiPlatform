"""
Platform Ops Exports routes — CSV exports for operations/admin use.

Migrated from aiPlat-core/core/api/routers/ops_exports.py per architecture contract:
...
router = APIRouter(prefix="/platform/ops", tags=["ops"])
