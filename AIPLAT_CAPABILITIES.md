...
| ModelManager | `aiPlat-infra/infra/management/model/manager.py` + `config/providers.yaml` | ✅ | 自动同步；provider 生态 22 家族（2026-08-24 一批 +qwen/groq/mistral/cohere/cerebras/together/xai/novita；2026-08-25 二批 +siliconflow/moonshot/minimax/zhipu/baichuan/stepfun/deepinfra/fireworks，YAML 驱动零代码） | 已合入 |
|------|------|:---:|------|------|
