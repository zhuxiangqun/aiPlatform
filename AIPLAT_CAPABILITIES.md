...
core_guarantees:
  ...
  configurable:  # 24 consumed by engine
    - id: agent_type
      field: PipelineStageConfig.agent_type
      ...
      consumed_at:
        - aiPlat-core/core/harness/execution/pipeline_engine.py::10539
        - aiPlat-core/core/harness/execution/pipeline_engine.py::6357
        - aiPlat-core/core/harness/execution/pipeline_engine.py::10493
    ...
    - id: context_profile
      ...
      consumed_at:
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3739
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3662
    ...
    - id: deploy_files_to_disk
      ...
      schema_default: False
      consumed_at:
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3941
    - id: enable_query_rewrite
      ...
      schema_default: True
      consumed_at:
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3732
    - id: execution_backend
      ...
      schema_default: llm
      consumed_at:
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3782
    - id: failure_strategy
      field: PipelineStageConfig.failure_strategy
      schema_default: fail_pipeline
      consumed_at:
        - aiPlat-core/core/harness/execution/pipeline_engine.py::6651
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3622
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3910
        - aiPlat-core/core/harness/execution/pipeline_engine.py::6240
        - aiPlat-core/core/harness/execution/pipeline_engine.py::10261
    - id: generate_test_plan
      field: PipelineStageConfig.generate_test_plan
      schema_default: False
      consumed_at:
        ...
        - aiPlat-core/core/harness/execution/pipeline_engine.py::8089
        - aiPlat-core/core/harness/execution/pipeline_engine.py::10543
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3922
    - id: hitl
      field: PipelineStageConfig.hitl
      schema_default: False
      consumed_at:
        - aiPlat-core/core/harness/execution/pipeline_engine.py::6435
        - aiPlat-core/core/harness/execution/pipeline_engine.py::7438
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3945
    - id: hitl_phase
      field: PipelineStageConfig.hitl_phase
      schema_default: 
      consumed_at:
        ...
        - aiPlat-core/core/harness/execution/pipeline_engine.py::4389
    - id: output_artifact
      field: PipelineStageConfig.output_artifact
      schema_default: 
      consumed_at:
        ...
        - aiPlat-core/core/harness/execution/pipeline_engine.py::7659
        - aiPlat-core/core/harness/execution/pipeline_engine.py::7027
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3268
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3699
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3886
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3949
        - aiPlat-core/core/harness/execution/pipeline_engine.py::4122
        - aiPlat-core/core/harness/execution/pipeline_engine.py::4212
        - aiPlat-core/core/harness/execution/pipeline_engine.py::4397
        - aiPlat-core/core/harness/execution/pipeline_engine.py::8693
        - aiPlat-core/core/harness/execution/pipeline_engine.py::8695
        - aiPlat-core/core/harness/execution/pipeline_engine.py::9853
        - aiPlat-core/core/harness/execution/pipeline_engine.py::11319
    - id: pipeline_mode
      field: PipelineStageConfig.pipeline_mode
    ...
    - id: quality_gate
      ...
      schema_default: "Lambda(args=arguments(), body=Dict(keys=[Constant(value='min_output_length')], 
      consumed_at:
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3880
    - id: retry_policy
      field: PipelineStageConfig.retry_policy
      description: "Self-heal retry: {on, action, max_retries}"
      schema_default: "Lambda(args=arguments(), body=Dict(keys=[Constant(value='max_retries'), Constan
      consumed_at:
        - aiPlat-core/core/harness/execution/pipeline_engine.py::7461
    - id: review_gate
      field: PipelineStageConfig.review_gate
      description: "none" | "quick" | "llm" | "hitl" — default quick for safety"
      schema_default: quick
      consumed_at:
        - aiPlat-core/core/harness/execution/pipeline_engine.py::4271
    - id: sandbox
      field: PipelineStageConfig.sandbox
      schema_default: False
      consumed_at:
    ...
    - id: sandbox_mode
      ...
      consumed_at:
        - aiPlat-core/core/harness/execution/pipeline_engine.py::6196
    - id: scoring_dimensions
      field: PipelineStageConfig.scoring_dimensions
      schema_default: "Lambda(args=arguments(), body=List(elts=[Dict(keys=[Constant(value='name'), Con
      consumed_at:
    ...
    - id: skill_model_purpose
      ...
      schema_default: 
      consumed_at:
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3610
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3619
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3781
    - id: skill_name
      field: PipelineStageConfig.skill_name
      description: "e.g., "architecture_design", "code_generation"
      schema_default: 
      consumed_at:
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3597
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3617
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3650
    ...
    - id: test_result_key
      ...
      consumed_at:
        ...
        - aiPlat-core/core/harness/execution/pipeline_engine.py::7430
        - aiPlat-core/core/harness/execution/pipeline_engine.py::8089
        - aiPlat-core/core/harness/execution/pipeline_engine.py::3937
    - id: uses_file_output
      field: PipelineStageConfig.uses_file_output
      schema_default: False
      consumed_at:
        ...
        - aiPlat-core/core/harness/execution/pipeline_engine.py::9825
        - aiPlat-core/core/harness/execution/pipeline_engine.py::9851
        - aiPlat-core/core/harness/execution/pipeline_engine.py::9800
